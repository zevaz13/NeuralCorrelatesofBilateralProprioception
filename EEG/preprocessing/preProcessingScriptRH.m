...
cond = 'RH'; % can be 'VIS' and 'RH'
debug = 0; % defines if we want to see the hardware triggers
for si = 1:length(subs)
%     % novis
    path = ['C:\Users\rued7682\OneDrive - University of Idaho\proprioception\data\' subs{si} '\' subs{si} '_RH001\'];
    targetFolder = ['D:\AMICAtest\prePropData\' subs{si} '\RH\'];
    mkdir(targetFolder);
    % imports sets 
