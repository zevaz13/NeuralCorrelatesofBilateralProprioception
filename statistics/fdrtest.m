% fdrtest() - Executes the Benjamini & Hochberg (1995) and the Benjamini &
...
%
% Usage:
%  >> [h, crit_p, adj_ci_cvrg, adj_p]=fdrtest(pvals,q,method,report);
%
% Required Input:
...
function [h, crit_p, adj_ci_cvrg, adj_p]=fdrtest(pvals,q,method,report)
if nargin<1,
